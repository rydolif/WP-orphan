...
//------------------Register Custom Post Истории----------------------
    function history_post_type() {
        $labels = array(
            'name'                  => _x( 'Истории', 'Post Type General Name', 'text_domain' ),
            'singular_name'         => _x( 'Истории', 'Post Type Singular Name', 'text_domain' ),
            'menu_name'             => __( 'Истории', 'text_domain' ),
            'all_items'             => __( 'Истории', 'text_domain' ),
            'add_new_item'          => __( 'Добавить Историю', 'text_domain' ),
            'add_new'               => __( 'Добавить Историю', 'text_domain' ),
        );
        $args = array(
            'label'                 => __( 'Истории', 'text_domain' ),
            'labels'                => $labels,
            'supports'              => array( 'title', 'editor', 'thumbnail'),// 'title','editor','author','thumbnail','excerpt','trackbacks','custom-fields','comments','revisions','page-attributes','post-formats'
            'hierarchical'          => false,
            'public'                => true,
...
//------------------Register Custom Post project----------------------
    function project_post_type() {
        $labels = array(
            'name'                  => _x( 'Реалізовані проекти', 'Post Type General Name', 'text_domain' ),
            'singular_name'         => _x( 'Реалізовані проекти', 'Post Type Singular Name', 'text_domain' ),
            'menu_name'             => __( 'Реалізовані проекти', 'text_domain' ),
            'all_items'             => __( 'Реалізовані проекти', 'text_domain' ),
            'add_new_item'          => __( 'Добавить проект', 'text_domain' ),
            'add_new'               => __( 'Добавить проект', 'text_domain' ),
        );
        $args = array(
            'label'                 => __( 'Реалізовані проекти', 'text_domain' ),
            'labels'                => $labels,
...
//------------------Register Custom Post sos----------------------
    function sos_post_type() {
        $labels = array(
            'name'                  => _x( 'SOS', 'Post Type General Name', 'text_domain' ),
            'singular_name'         => _x( 'SOS', 'Post Type Singular Name', 'text_domain' ),
            'menu_name'             => __( 'SOS', 'text_domain' ),
            'all_items'             => __( 'SOS', 'text_domain' ),
            'add_new_item'          => __( 'Добавить проект', 'text_domain' ),
            'add_new'               => __( 'Добавить проект', 'text_domain' ),
        );
        $args = array(
            'label'                 => __( 'SOS', 'text_domain' ),
            'labels'                => $labels,
            'supports'              => array( 'title', 'editor', 'thumbnail'),// 'title','editor','author','thumbnail','excerpt','trackbacks','custom-fields','comments','revisions','page-attributes','post-formats'
            'hierarchical'          => false,
            'public'                => true,
        ...
        register_post_type( 'sos', $args );
    }
    add_action( 'init', 'sos_post_type', 0 );


//------------------Register Custom Post fond----------------------
    function fond_post_type() {
        $labels = array(
            'name'                  => _x( 'Проекти фонду', 'Post Type General Name', 'text_domain' ),
            'singular_name'         => _x( 'Проекти фонду', 'Post Type Singular Name', 'text_domain' ),
            'menu_name'             => __( 'Проекти фонду', 'text_domain' ),
            'all_items'             => __( 'Проекти фонду', 'text_domain' ),
            'add_new_item'          => __( 'Добавить проект', 'text_domain' ),
            'add_new'               => __( 'Добавить проект', 'text_domain' ),
        );
        $args = array(
            'label'                 => __( 'Проекти фонду', 'text_domain' ),
            'labels'                => $labels,
            'supports'              => array( 'title', 'editor', 'thumbnail', 'excerpt'),// 'title','editor','author','thumbnail','excerpt','trackbacks','custom-fields','comments','revisions','page-attributes','post-formats'
            'hierarchical'          => false,
            'public'                => true,
